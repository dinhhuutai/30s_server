function findPosFirstAndTwo(content) {
    ...
    let stringChildTestTmp = content.slice(
        firstTwoPositions[0],
        firstTwoPositions[1]
    );
    ...
    while (
        !isFinite(Number(stringChildTestTmp[1])) &&
        stringChildTestTmp.length > 2
    ) {
    ...
    if (
        ...
        let stringChildTest = content.slice(
            firstTwoPositions[0],
            firstTwoPositions[1]
        );
        ...
        content[firstTwoPositions[1]] === "b" &&
        (content[firstTwoPositions[1] + 1] === "u" ||
            content[firstTwoPositions[1] + 1] === "d") &&
        (content[firstTwoPositions[1] + 2] === "." ||
            isFinite(Number(content[firstTwoPositions[1] + 2])))
    ) {
        let stringChildTest = content.slice(
